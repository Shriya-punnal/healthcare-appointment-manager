...
export default function DashboardLayout({
  ...
  return (
    ...
    >
      <DashboardLayoutContent setSidebarWidth={setSidebarWidth} navigation={navigation} brand={brand}>
        {children}
            ...
            <div className="flex items-center gap-3 px-2 transition-all w-full">
              ...
              {!isCollapsed ? (
                <div className="flex items-center gap-2 min-w-0">
                    <span className="font-semibold tracking-tight truncate font-editorial text-lg">
                      {brand}
                  </span>
                </div>
              ) : null}
